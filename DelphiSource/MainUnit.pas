...
uses
  ...
  Vcl.Graphics,Vcl.Controls,Vcl.Forms,Vcl.Dialogs,Vcl.StdCtrls,DiscImage,
  {System.Types,}Vcl.ExtCtrls,DateUtils,Vcl.ComCtrls,System.ImageList,Vcl.ImgList,
  Vcl.Buttons,Vcl.Imaging.pngimage, Vcl.Menus,System.IOUtils;
...
begin
 ...
 begin
  ...
  if not DirectoryExists(path+windowsfilename) then
   TDirectory.CreateDirectory(path+windowsfilename);
